...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float time_spent        = (stop_time - start_time) / 125000000.0; // given 125 MHz clock
    float bytes_transferred = 2048 * 8; // for Megabytes
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Alex Wozneak - Custom Peripheral Demonstration\n\r");
